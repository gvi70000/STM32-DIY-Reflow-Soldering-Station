...
#define INT_TO_BYTES(value, data) \
	do { \
		data[0] = (value >> 8) & 0xFF; \
		data[1] = value & 0xFF; \
	} while (0)
...
#define ST7735_Unselect	GPIOA->ODR |= LCD_CS_Pin;
#define ST7735_Select		GPIOA->ODR &= ~LCD_CS_Pin;

#define LCD_RST_ON GPIOA->ODR |= GPIO_PIN_8;
#define LCD_RST_OFF GPIOA->ODR &= ~GPIO_PIN_8;

#define LCD_CMD_ON GPIOB->ODR |= GPIO_PIN_12;
#define LCD_CMD_OFF GPIOB->ODR &= ~GPIO_PIN_12;
